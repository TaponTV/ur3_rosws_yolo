...
echo_and_run cd "/home/alan_tapia/ros_ws/src/universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/alan_tapia/ros_ws/src/universal_robot/ur_kinematics/setup.py" \
     \
    build --build-base "/home/alan_tapia/ros_ws/build/universal_robot/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
