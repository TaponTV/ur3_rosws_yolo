...
echo_and_run cd "/home/alan_tapia/ros_ws/src/robotiq_urcap_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/alan_tapia/ros_ws/src/robotiq_urcap_control/setup.py" \
     \
    build --build-base "/home/alan_tapia/ros_ws/build/robotiq_urcap_control" \
    install \
    --root="${DESTDIR-/}" \
