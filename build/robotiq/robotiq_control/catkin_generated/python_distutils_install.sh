...
echo_and_run cd "/home/alan_tapia/ros_ws/src/robotiq/robotiq_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/alan_tapia/ros_ws/src/robotiq/robotiq_control/setup.py" \
     \
    build --build-base "/home/alan_tapia/ros_ws/build/robotiq/robotiq_control" \
    install \
    --root="${DESTDIR-/}" \
